...
import static com.shazam.fork.injector.summary.AttachmentRetrieverInjector.attachmentRetriever;
...
public class SummaryPrinterInjector {
    ...
    private static SummaryPrinter htmlSummaryPrinter() {
        return new HtmlSummaryPrinter(configuredOutput(), logCatRetriever(), attachmentRetriever(), htmlGenerator());
    }
