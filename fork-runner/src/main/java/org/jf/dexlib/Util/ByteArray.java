...
public final class ByteArray {
     ...
     *
     * @param off <code>&gt;= 0, &lt; size(); </code>offset to fetch
     ...
     *
     * @param off <code>&gt;= 0, &lt; (size() - 1); </code> offset to fetch
     ...
     *
     * @param off <code>&gt;= 0, &lt; (size() - 3); </code> offset to fetch
     ...
     *
     * @param off <code>&gt;= 0, &lt; (size() - 7); </code> offset to fetch
     * @return <code>signed int</code> at that offset
     */
