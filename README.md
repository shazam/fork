...
buildscript {
  dependencies {
    classpath 'com.shazam.fork:fork-gradle-plugin:3.8.1'
  }
}
```
#### Snapshot
...
buildscript {
  ...
  dependencies {
    classpath 'com.shazam.fork:fork-gradle-plugin:3.9.0-SNAPSHOT
  }
}
```
...
```
    androidTestImplementation "com.shazam.fork:fork-client:3.8.1"
```
...
buildscript {
    dependencies {
        classpath "com.shazam.fork:fork-reporter-jenkins-gradle-plugin:3.8.1"
    }
    repositories {
...
buildscript {
    dependencies {
        classpath 'com.shazam.chimprunner:chimprunner-gradle-plugin:3.8.1'
    }
}
```
