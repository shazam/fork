...
```gradle
    androidTestImplementation "com.shazam.fork:fork-client:3.15.0"
```
...
buildscript {
    dependencies {
        classpath "com.shazam.fork:fork-reporter-jenkins-gradle-plugin:3.15.0"
    }
    repositories {
...
buildscript {
    dependencies {
        classpath 'com.shazam.chimprunner:chimprunner-gradle-plugin:3.15.0'
    }
}
```
