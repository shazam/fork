...
buildscript {
  dependencies {
    classpath 'com.shazam.fork:fork-gradle-plugin:3.9.0'
  }
}
```
#### Snapshot
...
buildscript {
  ...
  dependencies {
    classpath 'com.shazam.fork:fork-gradle-plugin:3.10.0-SNAPSHOT
  }
}
```
...
buildscript {
    dependencies {
        classpath "com.shazam.fork:fork-reporter-jenkins-gradle-plugin:3.9.0"
    }
    repositories {
...
buildscript {
    dependencies {
        classpath 'com.shazam.chimprunner:chimprunner-gradle-plugin:3.9.0'
    }
}
```
