...
buildscript {
  dependencies {
    classpath 'com.shazam.fork:fork-gradle-plugin:3.4.0'
  }
}
```
#### Snapshot
...
```
    androidTestImplementation "com.shazam.fork:fork-client:3.4.0"
```
...
buildscript {
    dependencies {
        classpath "com.shazam.fork:fork-reporter-jenkins-gradle-plugin:3.4.0"
    }
    repositories {
...
buildscript {
    dependencies {
        classpath 'com.shazam.chimprunner:chimprunner-gradle-plugin:3.4.0'
    }
}
```
